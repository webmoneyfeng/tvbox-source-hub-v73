...
test('catalog-release cron every 6 hours passes free-tier static freshness target', () => {
...
test('twice daily catalog-release cron fails 6-hour static freshness target', () => {
  ...
  assert.equal(check.root_cause, 'STATIC_WORKFLOW_SCHEDULE_GAP');
