...
- 源发现：candidate=29；ACTIVE/WATCH/REJECTED/BLOCKED=16/6/2/5
...
- https://tv.webhome.eu.org；config=200；status=200；sites=影视点播 · 405001706202；visible=405001706202
- https://tv.webclound.eu.org；config=200；status=200；sites=影视点播 · 405001706202；visible=405001706202
...
1. P3；snapshot；快照 warning 已分诊为观察项；证据：total=1；visible=0；by_type=UI_HIDE_CANDIDATE=1；建议：继续收敛 SNAPSHOT_PACK_GAP 与 UI_HIDE_CANDIDATE；当前不把它升级为用户可见投诉，但仍阻止宣称终局完成。
