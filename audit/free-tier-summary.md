...
- PASS；cloudflare_pages_files；300；dist 静态快照采用打包文件，不采用每个节目一个文件。
- PASS；cloudflare_pages_size；34327602 bytes；dist 总体积处于轻量级静态分发范围。
