...
- PASS；cloudflare_kv_hot_probe_writes；816/1000 writes/day；热探针写入单个 hot:last-success KV key；定时约 720/day，交互兜底最多 96/day，合计低于 Workers KV 免费层 1000 writes/day。
