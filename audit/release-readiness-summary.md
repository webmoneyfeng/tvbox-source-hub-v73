...
## 检查项
- PASS；worker-status；OK；Worker hot update is within freshness guard；code=655001706202；age=2min
- WARN；online-worker-full-config；NEEDS_WORKER_DEPLOY；visible update code still lives in site name, TV apps can cache it and show stale time；code=655001706202
- WARN；online-worker-clean-config；NEEDS_WORKER_DEPLOY；visible update code still lives in site name, TV apps can cache it and show stale time；code=655001706202
