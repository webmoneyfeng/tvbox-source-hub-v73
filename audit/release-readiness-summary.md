...
## 检查项
- PASS；worker-status；OK；Worker hot update is within freshness guard；code=625001706202；age=1min
- WARN；online-worker-full-config；NEEDS_WORKER_DEPLOY；visible update code still lives in site name, TV apps can cache it and show stale time；code=625001706202
- WARN；online-worker-clean-config；NEEDS_WORKER_DEPLOY；visible update code still lives in site name, TV apps can cache it and show stale time；code=625001706202
- PASS；local-dist-full-config；OK；stable site name with versioned API；code=530001706202
- PASS；local-dist-clean-config；OK；stable site name with versioned API；code=530001706202
